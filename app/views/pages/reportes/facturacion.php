...
$this->pushJs("pages/facturacion/facturacion.js?v=" . time());
...
<head>
    ...
    <title>Reportes | Reporte Financiero</title>
</head>
...
<body>
    ...
    <style>
        .card-panel {
            ...
            margin-left: 270px; /* Ajuste para el menú lateral estático de Sofit Gym */
            background: #ffffff;
            padding: 30px;
            border-radius: 8px;
        ...
        .reporte-financiero h5 {
            color: #16336b; /* Color institucional Azul Sofit Gym */
            font-weight: bold;
            margin-bottom: 15px;
        }
        ...
        @media (max-width: 991px) {
            .card-panel {
                margin-left: 0; /* Colapsar el margen si el menú lateral se oculta en móviles */
                width: 100%;
            }
        }
    </style>
